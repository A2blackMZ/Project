...
import { UtilizerCreateComponent } from './utilizers/utilizer-create/utilizer-create.component';
...
const routes: Routes = [
  ...
  { path: 'rapports', component: ReportDetailComponent },
  ...
  { path: 'utilizer', component: UtilizerCreateComponent },
];
